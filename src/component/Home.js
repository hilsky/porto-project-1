...
import {  Nav, NavDropdown, Form,  FormControl, Button, Table, ProgressBar, Card, CardImg, Image, Modal, ModalDialog, ModalBody} from 'react-bootstrap';
...
const Home= () => {
  ...
  <body>
    <div>
     <div className='d-flex flex-row justify-content-center headerContent' data-aos="fade-zoom-out" id="home">
     ...
     <div style={{marginTop: 30}} className='d-flex flex-column justify-content-center'>
       <div className='headerAbout' data-aos="fade-zoom-out" id="about">
         About Me
       </div>
     ...
     <Modal
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title style={{fontSize: 40}}>Hire Me</Modal.Title>
        </Modal.Header>
        <Modal.Body>
        <Form>
          <Form.Group className="mb-3" controlId="formBasicEmail">
            <Form.Label style={{fontSize: 20}}>Email address</Form.Label>
            <Form.Control type="email" placeholder="Enter email" style={{fontSize: 20}} />
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control type="text" placeholder="Name" style={{fontSize: 20}}/>
          </Form.Group>
          <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
            <Form.Label style={{fontSize: 20}}>Address</Form.Label>
            <Form.Control type="text" placeholder="Adress" style={{fontSize: 20}} />
          </Form.Group>
          <Form.Group className="mb-3">
            <Form.Label style={{fontSize: 20}}>Messege</Form.Label>
            <Form.Control as="textarea" placeholder="Your Messege" style={{fontSize: 20}} row="5"/>
          </Form.Group>
        </Form>
        </Modal.Body>
        <Modal.Footer>
